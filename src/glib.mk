...
$(PKG)_IGNORE   :=
$(PKG)_VERSION  := 2.84.2
$(PKG)_CHECKSUM := 88e960dd937057407d61fcb3b45a860704b25923c37ae2478b85f2ecb5a4021f
...
define $(PKG)_BUILD
    ...
    cd '$(SOURCE_DIR)' && '$(TARGET)-meson' --buildtype='$(MESON_BUILD_TYPE)' -Dtests=false '$(BUILD_DIR)'
    cd '$(BUILD_DIR)' && ninja
    cd '$(BUILD_DIR)' && ninja install
endef
