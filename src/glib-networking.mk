...
define $(PKG)_BUILD
    cd '$(SOURCE_DIR)' && CFLAGS='-liconv $(if $(BUILD_STATIC),-DGNUTLS_INTERNAL_BUILD)' '$(TARGET)-meson' --buildtype='$(MESON_BUILD_TYPE)' -Dgnutls=enabled -Dopenssl=enabled -Dinstalled_tests=false -Dlibproxy=disabled -Dgnome_proxy=disabled '$(BUILD_DIR)'
    cd '$(BUILD_DIR)' && ninja
