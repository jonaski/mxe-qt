...
$(PKG)_IGNORE   :=
$(PKG)_VERSION  := 2.76.1
$(PKG)_CHECKSUM := 5c698a9994dde51efdfb1026a56698a221d6250e89dc50ebcddda7b81480a42b
...
define $(PKG)_BUILD
    cd '$(SOURCE_DIR)' && CFLAGS='-liconv' '$(TARGET)-meson' --buildtype='$(MESON_BUILD_TYPE)' -Dgnutls=enabled -Dopenssl=enabled -Dinstalled_tests=false -Dlibproxy=disabled -Dgnome_proxy=disabled '$(BUILD_DIR)'
    cd '$(BUILD_DIR)' && ninja
