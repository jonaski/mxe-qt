...
define $(PKG)_BUILD_COMMON
    ...
    cd '$(BUILD_DIR)' && '$(SOURCE_DIR)/source/configure' $(MXE_CONFIGURE_OPTS) --with-cross-build='$(PREFIX)/$(BUILD)/$(PKG)' --enable-icu-config=no SHELL=$(SHELL) CXXFLAGS='-std=gnu++17' LIBS='-lstdc++' $($(PKG)_CONFIGURE_OPTS)
